...
/**
 * Admin console for adding tailors/admins and managing everyone's role —
 * lives inside the Admin Settings tab. Previously a standalone modal
 * (TeamRolesManager); folded in here as a plain section.
 */
