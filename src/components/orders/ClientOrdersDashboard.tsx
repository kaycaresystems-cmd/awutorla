  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10">
      <div className="text-center space-y-3 max-w-xl mx-auto">
        ...
        <h2 className="text-2xl sm:text-3xl">My Orders</h2>
      ...
      {!isLoading && (
        <>
          ...
          <div
            ...
            className="p-6 glass cursor-pointer hover:bg-white/70 transition-all"
          >
                ...
                {currentOrders.map((order) => {
                  ...
                  return (
                    <div
                      ...
                      className="glass p-5 hover:bg-white/70 transition-all cursor-pointer flex flex-col gap-4"
                    >
          ...
          {pastOrders.length > 0 && (
            <div className="space-y-4">
              ...
              <div className="glass divide-y divide-gray-200 overflow-hidden">
                {pastOrders.map((order) => (
                  <div
                    key={order.id}
                    onClick={() => onViewOrder(order.id)}
                    className="p-4 sm:p-5 flex justify-between items-center gap-3 cursor-pointer hover:bg-white/50 transition-colors"
                  >
